/**
 * server/engines/finance/FinancialHealthEngine.ts - CORRECTED
 *
 ...
 *
 * ✅ FIXED: Added assessFinancialHealth method (wrapper for calculateFinancialHealth)
 *
 * Dimensions:
...
export class FinancialHealthEngine {
   ...
   * Implementation method - refactored to support both method names.
   */
  private async assessFinancialHealthImpl(
    organizationId: number,
    operatingUnitId?: number | null
  ...
  async calculateFinancialHealth(
    ...
    return this.assessFinancialHealthImpl(organizationId, operatingUnitId);
  }

  /**
   * ✅ FIXED: Alias method for router compatibility
   * Router calls assessFinancialHealth, but implementation is calculateFinancialHealth
   */
