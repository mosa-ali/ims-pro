...
export function UnifiedExportButton({
 ...
 const labels = {
 exportExcel: t.components.exportExcel,
 exportModalTitle: t.components.exportExcelFile,
 exportWithData: t.components.exportWithData,
 exportTemplate: t.components.exportBlankTemplate,
 ...
 exporting: t.components.exporting
 };
 ...
 className={`px-3 py-2 text-sm border border-gray-300 rounded-md hover:bg-gray-50 disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2 ${className}`}
 >
 ...
 disabled={isExporting}
 className={`w-full p-4 border-2 border-green-200 rounded-lg hover:border-green-400 hover:bg-green-50 transition-colors text-start disabled:opacity-50 disabled:cursor-not-allowed text-start`}
 >
 ...
 {labels.exportWithData}
 </div>
 <div className="text-sm text-gray-600">
 {labels.exportWithDataDesc}
 </div>
 </div>
 </div>
 </button>
 ...
 disabled={isExporting}
 className={`w-full p-4 border-2 border-blue-200 rounded-lg hover:border-blue-400 hover:bg-blue-50 transition-colors disabled:opacity-50 disabled:cursor-not-allowed text-start`}
 >
 <div className={`flex items-start gap-3`}>
