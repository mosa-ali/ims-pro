...
function DashboardLayoutContent({
 ...
 try {
 await logout();
 // Wait for logout to complete and cache to clear
 // Use replace() instead of href to prevent back button returning to organization page
 // Redirect to /login page (not OAuth portal)
 setTimeout(() => {
