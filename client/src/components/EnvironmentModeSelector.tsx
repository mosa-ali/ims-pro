...
export function EnvironmentModeSelector() {
 ...
 {showSelector && (
 <div className="absolute top-full mt-2 end-0 bg-white rounded-lg shadow-lg border border-gray-200 p-3 z-50 min-w-[280px]">
 ...
 className={`w-full text-start px-3 py-2 rounded text-xs font-medium transition-colors ${ mode === currentMode ? getModeColor(mode) + ' font-bold' : 'bg-gray-50 text-gray-700 hover:bg-gray-100' }`}
 >
