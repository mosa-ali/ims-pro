...
export function MainDashboard() {
 ...
 {t.components.integratedManagementSystem}
 </p>
 </div>
 <button
 onClick={logout}
 ...
 className={`p-4 border-2 rounded-lg text-start transition-colors ${ org.id === currentOrganization.id ? 'border-blue-600 bg-blue-50' : 'border-gray-200 hover:border-blue-400 hover:bg-gray-50' }`}
 >
