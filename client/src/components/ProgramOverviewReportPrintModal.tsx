...
export function ProgramOverviewReportPrintModal({
 ...
 return new Intl.NumberFormat(t.printTemplates.en).format(num);
 };
 ...
 const labels = {
 title: t.printTemplates.programOverviewReport,
 subtitle: t.printTemplates.strategicPortfolioSummary,
 
 programInfo: t.printTemplates.programInformation,
 programName: t.printTemplates.programName,
 programCode: t.printTemplates.programCode,
 programManager: t.printTemplates.programManager,
 ...
 activeProjects: t.printTemplates.activeProjects,
 
 executiveSummary: t.printTemplates.k1ExecutiveSummary,
 strategicObjectives: t.printTemplates.k2StrategicObjectives,
 
 portfolio: t.printTemplates.k3ProjectPortfolio,
 projectName: t.printTemplates.project,
 code: t.printTemplates.code,
 status: t.printTemplates.status,
 budget: t.printTemplates.budget,
 spent: t.printTemplates.spent1,
 progress: t.printTemplates.progress,
 
 metrics: t.printTemplates.k4ProgramlevelMetrics,
 indicator: t.printTemplates.indicator,
 target: t.printTemplates.target,
 achieved: t.printTemplates.achieved2,
 achievement: t.printTemplates.achievement,
 
 resources: t.printTemplates.k5ResourceAllocation,
 category: t.printTemplates.category,
 allocated: t.printTemplates.allocated,
 utilized: t.printTemplates.utilized,
 available: t.printTemplates.available,
 
 thematic: t.printTemplates.k6ThematicAreas,
 area: t.printTemplates.area,
 projects: t.printTemplates.projects,
 
 achievements: t.printTemplates.k7KeyAchievements,
 challenges: t.printTemplates.k8ChallengesMitigation,
 nextSteps: t.printTemplates.k9NextSteps,
 
 onTrack: t.printTemplates.onTrack,
