...
export function ProjectCharterPrintModal({
 ...
 const labels = {
 title: t.printTemplates.projectCharter,
 subtitle: t.printTemplates.projectInitiationDocument,
 ...
 sponsor: t.printTemplates.projectSponsor,
 duration: t.printTemplates.duration4,
 budget: t.printTemplates.totalBudget,
 
 background: t.printTemplates.k1ProjectBackground,
 objectives: t.printTemplates.k2ProjectObjectives,
 priority: t.printTemplates.priority,
 high: t.printTemplates.high,
 medium: t.printTemplates.medium,
 low: t.printTemplates.low,
 
 scope: t.printTemplates.k3ProjectScope,
 inScope: t.printTemplates.inScope,
 outOfScope: t.printTemplates.outOfScope,
 
 team: t.printTemplates.k4ProjectTeamStructure,
 name: t.printTemplates.name,
 role: t.printTemplates.role,
 department: t.printTemplates.department,
 
 milestones: t.printTemplates.k5KeyMilestones,
 milestone: t.printTemplates.milestone,
 date: t.printTemplates.date,
 deliverable: t.printTemplates.deliverable,
 
 risks: t.printTemplates.k6KeyRisks,
 assumptions: t.printTemplates.k7KeyAssumptions,
 
 approval: t.printTemplates.approvalSignoff,
