...
export function CompetitiveBidAnalysisPrint({ cba }: Props) {
 ...
 <h3 className="text-lg font-semibold text-black mt-1">{isRTL ? 'تحليل العطاءات التنافسية' : 'Competitive Bid Analysis (CBA)'}</h3>
 </div>
 ...
 <span className="ms-2">{cba.cbaNumber}</span>
 </div>
 <div>
 <span className="font-semibold">PR Number:</span>
 <span className="ms-2">{cba.prNumber}</span>
 </div>
 <div>
 <span className="font-semibold">Date:</span>
 <span className="ms-2">{cba.cbaDate}</span>
 </div>
 <div>
 <span className="font-semibold">Currency:</span>
 <span className="ms-2">{cba.currency}</span>
 </div>
 {cba.country && (
 <div>
 <span className="font-semibold">Country:</span>
 <span className="ms-2">{cba.country}</span>
 </div>
 )}
 <div className="col-span-2">
 <span className="font-semibold">{isRTL ? 'بند الميزانية:' : 'Budget Line:'}</span>
 <span className="ms-2">{cba.budgetLineName}</span>
 </div>
 <div>
 <span className="font-semibold">{isRTL ? 'مبلغ الميزانية:' : 'Budget Amount:'}</span>
 <span className="ms-2 font-bold">{cba.currency} {cba.budgetAmount.toLocaleString()}</span>
 </div>
 </div>
 </div>
 ...
 <th className="border border-black px-2 py-2 text-start font-bold">
 Criteria
 </th>
 ...
 <td className="border border-black px-2 py-2 text-end">
 ...
 <th className="border border-black px-2 py-2 text-end font-bold">
 Offered Price
 </th>
 ...
 {bidder.companyName}
 {!isQualified && (
 <span className="ms-2 text-xs">(Not Qualified)</span>
 )}
 </td>
 <td className="border border-black px-2 py-2 text-end font-semibold">
 ...
 {bidder?.companyName}
 {score.rank === 1 && (
 <span className="ms-2 text-xs font-bold">★ HIGHEST SCORE</span>
 )}
 </td>
 <td className="border border-black px-2 py-2 text-center font-semibold">
 ...
 <div>
 <span className="font-semibold">{isRTL ? 'أقل مبلغ عطاء:' : 'Lowest Bid Amount:'}</span>
