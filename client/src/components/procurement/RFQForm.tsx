...
export function RFQForm({
 ...
 switch (rfq.status) {
 case 'draft':
 return <span className="px-3 py-1 bg-gray-100 text-gray-800 rounded-full text-sm font-medium">{isRTL ? 'مسودة' : 'Draft'}</span>;
 case 'sent':
 ...
 return <span className="px-3 py-1 bg-blue-100 text-blue-800 rounded-full text-sm font-medium">{isRTL ? 'الردود المستلمة' : 'Responses Received'}</span>;
 case 'closed':
 return <span className="px-3 py-1 bg-gray-100 text-gray-800 rounded-full text-sm font-medium">{isRTL ? 'مغلق' : 'Closed'}</span>;
 default:
 return null;
 }
 };
 ...
 <h2 className="text-xl font-bold text-gray-900">{isRTL ? 'طلب عرض أسعار' : 'Request for Quotation'}</h2>
 {statusBadge()}
 </div>
 ...
 <h2 className="text-xl font-bold text-gray-900 uppercase">{isRTL ? 'طلب عرض أسعار' : 'Request for Quotation'}</h2>
 ...
 <span className="ms-2 text-gray-900">{rfq.rfqNumber}</span>
 </div>
 <div>
 <span className="font-medium text-gray-700">PR Number:</span>
 <span className="ms-2 text-gray-900">{rfq.prNumber}</span>
 </div>
 <div>
 <span className="font-medium text-gray-700">{isRTL ? 'تاريخ الإصدار:' : 'Issue Date:'}</span>
 <span className="ms-2 text-gray-900">{formatDate(rfq.issueDate)}</span>
 </div>
 <div>
 <span className="font-medium text-gray-700">{isRTL ? 'الموعد النهائي للتقديم:' : 'Submission Deadline:'}</span>
 <span className="ms-2 font-bold text-red-600">{formatDate(rfq.submissionDeadline)}</span>
 </div>
 <div>
 <span className="font-medium text-gray-700">{isRTL ? 'طريقة الشراء:' : 'Procurement Method:'}</span>
 <span className="ms-2 text-gray-900">{rfq.procurementMethod === 'tender' ? 'Tender (> USD 25K)' : 'Quotation'}</span>
 </div>
 <div>
 <span className="font-medium text-gray-700">Currency:</span>
 <span className="ms-2 text-gray-900">{rfq.currency}</span>
 </div>
 </div>

 {/* Contact Information */}
 <div className="bg-gray-50 border border-gray-200 rounded-lg p-4 mb-6">
 <h3 className="text-sm font-bold text-gray-900 mb-3">{isRTL ? 'معلومات الاتصال' : 'Contact Information'}</h3>
 <div className="grid grid-cols-3 gap-4 text-sm">
 <div>
 <span className="font-medium text-gray-700">{isRTL ? 'جهة الاتصال:' : 'Contact Person:'}</span>
 ...
 {/* Items Table */}
 <div className="mb-6">
 <h3 className="text-sm font-bold text-gray-900 mb-3">{isRTL ? 'البنود المطلوبة' : 'Items Requested'}</h3>
 <table className="w-full border-collapse border border-gray-300 text-sm">
 <thead>
 <tr className="bg-gray-100">
 <th className="border border-gray-300 px-3 py-2 text-start font-medium">#</th>
 <th className="border border-gray-300 px-3 py-2 text-start font-medium">{isRTL ? 'وصف البند' : 'Item Description'}</th>
 <th className="border border-gray-300 px-3 py-2 text-start font-medium">Specification</th>
 <th className="border border-gray-300 px-3 py-2 text-center font-medium">{isRTL ? 'الكمية' : 'Quantity'}</th>
 <th className="border border-gray-300 px-3 py-2 text-center font-medium">{isRTL ? 'الوحدة' : 'Unit'}</th>
 </tr>
 </thead>
 <tbody>
 ...
 <h3 className="text-sm font-bold text-blue-900 mb-3">{isRTL ? 'متطلبات التسليم' : 'Delivery Requirements'}</h3>
 <div className="grid grid-cols-2 gap-4 text-sm">
 <div>
 <span className="font-medium text-blue-800">{isRTL ? 'موقع التسليم:' : 'Delivery Location:'}</span>
 <p className="text-blue-900 mt-1">{rfq.deliveryLocation}</p>
 </div>
 <div>
 <span className="font-medium text-blue-800">{isRTL ? 'تاريخ التسليم المطلوب:' : 'Required Delivery Date:'}</span>
 ...
 <div>
 <p className="text-sm font-medium text-gray-700 mb-8">{isRTL ? 'أعدّه:' : 'Prepared By:'}</p>
 ...
 <div>
 <p className="text-sm font-medium text-gray-700 mb-8">{isRTL ? 'اعتمده:' : 'Approved By:'}</p>
 <div className="border-t border-gray-400 pt-2">
 <p className="text-sm text-gray-600">{isRTL ? 'مدير اللوجستيات' : 'Logistics Manager'}</p>
 </div>
 </div>
 </div>
 </div>
 ...
 <h4 className="font-medium text-gray-900 mb-3">{isRTL ? 'إضافة مورد' : 'Add Supplier'}</h4>
 ...
 <h4 className="font-medium text-blue-900 mb-2">{isRTL ? 'الخطوات التالية:' : 'Next Steps:'}</h4>
