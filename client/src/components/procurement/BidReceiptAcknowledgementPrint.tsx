...
export function BidReceiptAcknowledgementPrint({
 ...
 return (
 <div className="print-document bg-white p-4">
 {/* PRINT HEADER */}
 <div className="mb-8">
 ...
 {/* Document Info Bar */}
 <div className={`grid grid-cols-2 gap-4 text-sm pt-4 border-t-4 border-black text-start`}>
 ...
 <p><span className="font-bold uppercase text-[10px] text-gray-500 block">{trans.printDate}</span> <span className="font-medium">{new Date().toLocaleString(t.procurement.enus1)}</span></p>
