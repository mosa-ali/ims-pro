...
export function BidEvaluationCriteriaPrint({ criteria }: Props) {
 ...
 <h3 className="text-lg font-semibold text-black mt-1">{isRTL ? 'معايير تقييم العطاءات / قائمة التحقق' : 'Bid Evaluation Criteria / Checklist'}</h3>
 </div>
 ...
 <span className="ms-2">{criteria.prNumber}</span>
 </div>
 <div>
 <span className="font-semibold">Tender/RFQ Number:</span>
 <span className="ms-2">{criteria.tenderRfqNumber || '-'}</span>
 </div>
 <div>
 <span className="font-semibold">{isRTL ? 'تاريخ التقييم:' : 'Evaluation Date:'}</span>
 <span className="ms-2">{criteria.evaluationDate}</span>
 </div>
 <div>
 <span className="font-semibold">{isRTL ? 'الوحدة التشغيلية:' : 'Operating Unit:'}</span>
 <span className="ms-2">{criteria.operatingUnitName}</span>
 </div>
 </div>
 </div>
 ...
 <td colSpan={3} className="border border-black px-2 py-2 text-end">
 TOTAL WEIGHT
 </td>
 ...
 <div>
 <p className="font-bold mb-1">{isRTL ? 'أعدّه:' : 'Prepared By:'}</p>
 ...
 <div>
 <p className="font-bold mb-1">{isRTL ? 'راجعه:' : 'Reviewed By:'}</p>
 <div className="border-t-2 border-black mt-8 pt-2">
 ...
 <div>
 <p className="font-bold mb-1">{isRTL ? 'اعتمده:' : 'Approved By:'}</p>
 <div className="border-t-2 border-black mt-8 pt-2">
