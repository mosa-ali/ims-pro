...
export function AddQuestionModal({
 ...
 const localT = {
 title: t.components.addQuestion,
 questionLabel: t.components.questionLabel,
 questionLabelPlaceholder: t.components.enterQuestionText,
 questionType: t.components.questionType,
 required: t.components.required,
 save: t.components.saveQuestion,
 cancel: t.components.cancel,
 selectionText: t.components.selectionText,
 numericDate: t.components.numericDate,
 media: t.components.media,
 locationGeometry: t.components.locationGeometry,
 advanced: t.components.advanced,
 };
 ...
 className={`p-4 rounded-lg border-2 transition-all text-start group ${ 'text-start' } ${ selectedType === qt.type ? 'border-blue-500 bg-blue-50' : 'border-gray-200 hover:border-blue-400 hover:bg-blue-50' }`}
 >
