...
export function GrantProgressReportPrintModal({
 ...
 const labels = {
 title: t.printTemplates.grantProgressReport,
 grantInfo: t.printTemplates.grantInformation,
 grantNumber: t.printTemplates.grantNumber,
 donor: t.printTemplates.donorfunder,
 reportPeriod: t.printTemplates.reportingPeriod,
 grantPeriod: t.printTemplates.grantPeriod,
 
 executiveSummary: t.printTemplates.executiveSummary,
 
 activities: t.printTemplates.activitiesProgress,
 activity: t.printTemplates.activity,
 planned: t.printTemplates.planned,
 actual: t.printTemplates.actual,
 status: t.printTemplates.status,
 
 indicators: t.printTemplates.indicatorsAchievement,
 indicator: t.printTemplates.indicator,
 target: t.printTemplates.target,
 achieved: t.printTemplates.achieved,
 progress: t.printTemplates.progress,
 
 budget: t.printTemplates.budgetUtilization,
 category: t.printTemplates.category,
 budgetAmount: t.printTemplates.budget,
 spent: t.printTemplates.spent,
 remaining: t.printTemplates.remaining,
 utilization: t.printTemplates.utilization,
 
 challenges: t.printTemplates.challengesIssues,
 nextSteps: t.printTemplates.nextStepsPlans,
 
 preparedBy: t.printTemplates.preparedBy,
 submittedTo: t.printTemplates.submittedTo,
 date: t.printTemplates.date,
 ...
 <p className="text-sm text-gray-600">{t.printTemplates.implementingPartner}</p>
 </div>
 ...
 <p className="text-sm text-gray-600">{t.printTemplates.donorfunder}</p>
 </div>
 </div>
 ...
 <td className="px-4 py-4 font-bold text-yellow-900 uppercase">{t.printTemplates.total}</td>
