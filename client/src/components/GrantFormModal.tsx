...
export function GrantFormModal({ isOpen, onClose, grant, onSuccess }: GrantFormModalProps) {
 ...
 const createMutation = trpc.grants.create.useMutation({onSuccess: () => {
 ...
 const updateMutation = trpc.grants.update.useMutation({onSuccess: () => {
 utils.grants.list.invalidate();
 utils.grants.getKPIs.invalidate();
 ...
 // If it's a string in ISO format or other date string, parse it
 ...
 placeholder={t.placeholders.eGGr2024001}
 required
 />
 </div>
 ...
 placeholder={t.placeholders.eGEducationSupportProgram}
 required
 />
 </div>
 </div>
 ...
 placeholder={t.placeholders.eGUnicef}
 required
 />
 </div>
 ...
 placeholder={t.placeholders.eGDonRef2024123}
 />
 </div>
 </div>
 </div>
 ...
 placeholder={t.placeholders.eG500000}
 required
 />
 </div>
 </div>
 ...
 placeholder={t.placeholders.eGWorldBank}
 />
 </div>
 )}
 </div>
 ...
 >
 <SelectTrigger>
 <SelectValue placeholder={t.placeholders.selectAProject} />
 </SelectTrigger>
 <SelectContent>
 ...
 placeholder={t.placeholders.eGEducationHealth}
 />
 </div>
 </div>
 ...
 placeholder={t.placeholders.eGJohnDoe}
 />
 </div>
 ...
 placeholder={t.placeholders.enterGrantDescriptionAndObjectives}
 rows={4}
 />
 </div>
