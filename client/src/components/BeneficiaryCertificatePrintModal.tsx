...
import { X, Printer, Award, Star, Shield } from 'lucide-react';
...
export function BeneficiaryCertificatePrintModal({
 ...
 const labels = {
 certificate: t.printTemplates.certificateOfCompletion,
 presentedTo: t.printTemplates.thisCertificateIsProudlyPresentedTo,
 recognition: language === 'en' 
 ? 'In recognition of successful completion of' 
 : 'تقديراً للإتمام الناجح لـ',
 
 programType: t.printTemplates.programType,
 duration: t.printTemplates.duration,
 completionDate: t.printTemplates.completionDate,
 hoursCompleted: t.printTemplates.hoursCompleted,
 achievementLevel: t.printTemplates.achievementLevel,
 
 skillsAcquired: t.printTemplates.skillsCompetenciesAcquired,
 
 basic: t.printTemplates.basic,
 intermediate: t.printTemplates.intermediate,
 advanced: t.printTemplates.advanced,
 
 outstanding: t.printTemplates.outstanding,
 excellent: t.printTemplates.excellent,
 good: t.printTemplates.good,
 satisfactory: t.printTemplates.satisfactory,
 
 issuedBy: t.printTemplates.issuedBy,
 signature: t.printTemplates.signature,
 dateLabel: t.printTemplates.date,
 seal: t.printTemplates.officialSeal,
 
 certificateNumber: t.printTemplates.certificateNo,
 ...
 from: t.printTemplates.from,
 to: t.printTemplates.to
 };
 ...
 if (months > 0) {
 return `${months} ${t.printTemplates.months}`;
 }
 return `${days} ${t.printTemplates.days}`;
 };
