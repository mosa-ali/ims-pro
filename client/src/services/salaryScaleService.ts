 ...
 */
 ...
 const staff = getStaffService().getActive(); // ✅ Changed from getAll() to getActive()
 ...
 const staff = getStaffService().getAll().find(s => s.staffId === staffId);
 ...
 */
 ...
 const activeStaff = getStaffService().getActive();
