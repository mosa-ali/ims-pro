...
function getSalaryScaleService() {
 const { salaryScaleService } = require('./salaryScaleService');
 return salaryScaleService;
}
 ...
 */
 ...
 const salaryScale = getSalaryScaleService().getActiveByStaffId(staff.staffId);
 ...
 getSalaryScaleService().markUsedInPayroll(staff.staffId);
...
function initializeSampleSalaryScales(): void {
 ...
 const existingScale = getSalaryScaleService().getActiveByStaffId(staff.staffId);
