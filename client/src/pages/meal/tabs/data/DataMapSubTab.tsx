...
export function DataMapSubTab({
 ...
 const localT = {
 map: t.mealTabs.submissionMap,
 noGPS: t.mealTabs.noGpsDataAvailable,
 gpsDesc: 'GPS coordinates from survey submissions will be displayed on the map',
 totalLocations: t.mealTabs.totalLocations,
 viewSubmission: t.mealTabs.viewSubmission,
 ...
 {t.submittedBy} {loc.submittedBy} {t.on} {new Date(loc.submittedAt).toLocaleDateString(t.mealTabs.enus)}
 </p>
 {loc.lat && loc.lng && (
