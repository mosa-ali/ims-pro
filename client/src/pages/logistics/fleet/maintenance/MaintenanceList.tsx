...
export default function MaintenanceList() {
 ...
 const { data: recordsData, isLoading } = trpc.logistics.maintenance.list.useQuery({});
 const records = recordsData?.items || [];

 const labels = {
 title: t.logistics.maintenanceRecords,
 ...
 <Button onClick={() => setLocation("/organization/logistics/fleet/maintenance/new")}>
 ...
 <TableHead>{labels.maintenanceType}</TableHead>
 ...
 <Button variant="ghost" size="icon" onClick={() => setLocation(`/organization/logistics/fleet/maintenance/${record.id}/edit`)}>
