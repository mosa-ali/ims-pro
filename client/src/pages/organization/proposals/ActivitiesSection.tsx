...
export function ActivitiesSection({
 ...
 const localT = {
 title: t.proposals.expectedResultsAndActivities,
 expectedResults: t.proposals.expectedResults,
 activities: t.proposals.activities,
 resultNumber: t.proposals.result,
 resultDescription: t.proposals.resultDescription,
 linkedObjective: t.proposals.linkedObjective,
 addResult: t.proposals.addResult,
 activityNumber: t.proposals.activity,
 activityDescription: t.proposals.activityDescription,
 linkedResult: t.proposals.linkedResult,
 startMonth: t.proposals.startMonth,
 endMonth: t.proposals.endMonth,
 responsibleParty: t.proposals.responsibleParty,
 addActivity: t.proposals.addActivity,
 import: t.proposals.importFromExcel,
 export: t.proposals.exportToExcel
 };
 ...
 placeholder={t.placeholders.describeTheExpectedResult}
 />
 </td>
 <td className="px-3 py-2 border border-gray-300">
 <select
 ...
 className="w-full px-2 py-1 border border-gray-300 rounded text-sm"
 placeholder={t.placeholders.describeTheActivity}
 />
 </td>
 <td className="px-3 py-2 border border-gray-300">
 <select
 ...
 className="w-full px-2 py-1 border border-gray-300 rounded text-sm"
 placeholder={t.placeholders.teamPerson}
 />
 </td>
 </tr>
 ))}
...
export function ImplementationPlanSection({
 ...
 activity: t.proposals.activity1,
 activityName: t.proposals.activityName,
 linkedResult: t.proposals.linkedResult,
 timeline: t.proposals.timeline,
 startMonth: t.proposals.startMonth2,
 endMonth: t.proposals.endMonth,
 responsibleParty: t.proposals.responsibleParty,
 status: t.proposals.status,
 addPlanItem: t.proposals.addPlanItem,
 import: t.proposals.importFromExcel,
 export: t.proposals.exportToExcel
 };
 ...
 className="w-full px-2 py-1 border border-gray-300 rounded text-sm"
 placeholder={t.placeholders.activityMilestoneName}
 />
 </td>
 <td className="px-3 py-2 border border-gray-300">
 <select
 ...
 {(plan?.planItems || []).map((item: any, index: number) => (
 <tr key={index}>
 <td className="px-2 py-1 border border-gray-300 font-medium text-xs sticky start-0 bg-white z-10">
 {item.activityLabel || `P${index + 1}`}
 </td>
 {monthHeaders.map((month) => {
