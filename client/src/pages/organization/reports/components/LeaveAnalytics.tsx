...
export function LeaveAnalytics({
 ...
 {localT.leaveAnalytics}
 </h2>

 {/* Summary Cards */}
 <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
 <div className="bg-white border border-gray-200 rounded-[20px] p-8 shadow-sm">
 <p className="text-[10px] font-black text-gray-400 uppercase tracking-[2px] mb-2">{localT.totalDaysUsed}</p>
 <p className="text-4xl font-black text-indigo-600">{data.totalDaysUsed}</p>
 </div>
 <div className="bg-white border border-gray-200 rounded-[20px] p-8 shadow-sm">
 <p className="text-[10px] font-black text-gray-400 uppercase tracking-[2px] mb-2">{localT.avgPerStaff}</p>
 ...
 <p className="text-[10px] font-black text-gray-400 uppercase tracking-[2px] mb-2">{localT.leaveLiability}</p>
 ...
 <span className="text-xs font-black text-gray-400 mt-4 uppercase tracking-[1px]">{localT.daysTaken}</span>
 </div>
 ))}
 </div>
 </div>
