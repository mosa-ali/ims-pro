...
export function RecruitmentAnalytics({
 ...
 {localT.recruitmentAnalytics}
 </h2>

 {/* Summary Cards */}
 <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
 <div className="bg-white border border-gray-200 rounded-[20px] p-8 shadow-sm">
 <p className="text-[10px] font-black text-gray-400 uppercase tracking-[2px] mb-2">{localT.timeToHire}</p>
 <p className="text-4xl font-black text-orange-600">{data.timeToHire} {localT.days}</p>
 <p className="text-[10px] font-black text-emerald-600 mt-2 uppercase tracking-widest">
 {t.orgReports.target45Days}
 </p>
 </div>
 <div className="bg-white border border-gray-200 rounded-[20px] p-8 shadow-sm">
 <p className="text-[10px] font-black text-gray-400 uppercase tracking-[2px] mb-2">{localT.candidatesPerVacancy}</p>
 <p className="text-4xl font-black text-gray-900">{data.candidatesPerVacancy.toFixed(1)}</p>
 </div>
 <div className="bg-white border border-gray-200 rounded-[20px] p-8 shadow-sm">
 <p className="text-[10px] font-black text-gray-400 uppercase tracking-[2px] mb-2">{localT.selectionRate}</p>
 ...
 <tr>
 <th className="px-6 py-5 text-start text-[10px] font-black text-gray-400 uppercase tracking-[2px]">{localT.position}</th>
 <th className="px-6 py-5 text-center text-[10px] font-black text-gray-400 uppercase tracking-[2px]">{localT.daysOpen}</th>
 <th className="px-6 py-5 text-center text-[10px] font-black text-gray-400 uppercase tracking-[2px]">{localT.applicants}</th>
 <th className="px-6 py-5 text-end text-[10px] font-black text-gray-400 uppercase tracking-[2px]">{localT.status}</th>
 </tr>
 </thead>
