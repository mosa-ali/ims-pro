...
const [narratives, setNarratives] = useState({
 ...
 toast.success(
 'Report downloaded successfully and synced to Central Documents'
 );
 ...
 <html dir="${'ltr'}">
 <head>
 <title>${reportData.project?.titleEn || 'Project Report'} - Project Report</title>
 ...
 * { box-sizing: border-box; }
 ...
 saveAs(blob, `Project_Report_${reportData.project?.projectCode || 'Report'}_${new Date().toISOString().split('T')[0]}.xlsx`);
 };
 ...
 <CardTitle className="text-xl">{reportData.project?.titleEn || 'Unnamed Project'}</CardTitle>
 ...
 {calculateDaysRemaining()} {t.projectDetail.days}
 </span>
 </div>
 <div>
