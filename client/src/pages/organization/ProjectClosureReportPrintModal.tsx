...
export function ProjectClosureReportPrintModal({
 ...
 const [language, setLanguage] = useState<'en' | 'ar' | 'it'>('en');
 ...
 const labels = {
 title: t.organizationModule.projectClosureReport,
 subtitle: t.organizationModule.finalProjectDocumentation,
 ...
 plannedDuration: t.organizationModule.plannedDuration,
 actualDuration: t.organizationModule.actualDuration,
 
 executiveSummary: t.organizationModule.k1ExecutiveSummary,
 
 deliverables: t.organizationModule.k2DeliverablesStatus,
 deliverable: t.organizationModule.deliverable,
 status: t.organizationModule.status,
 notes: t.organizationModule.notes,
 completed: t.organizationModule.completed,
 partiallyCompleted: t.organizationModule.partiallyCompleted,
 notCompleted: t.organizationModule.notCompleted,
 
 achievements: t.organizationModule.k3ProjectAchievements,
 objective: t.organizationModule.objective,
 target: t.organizationModule.target,
 achieved: t.organizationModule.achieved16,
 achievement: t.organizationModule.achievement,
 
 lessons: t.organizationModule.k4LessonsLearned,
 category: t.organizationModule.category,
 description: t.organizationModule.description,
 recommendation: t.organizationModule.recommendation,
 success: t.organizationModule.success,
 challenge: t.organizationModule.challenge,
 improvement: t.organizationModule.improvement,
 
 budget: t.organizationModule.k5FinalBudgetSummary,
 budgeted: t.organizationModule.budgeted,
 actual: t.organizationModule.actual,
 variance: t.organizationModule.variance,
 under: t.organizationModule.underBudget,
 over: t.organizationModule.overBudget,
 
 recommendations: t.organizationModule.k6RecommendationsForFutureProjects,
 acknowledgments: t.organizationModule.k7Acknowledgments,
 
 closure: t.organizationModule.projectClosureApproval,
 closedBy: t.organizationModule.closedBy,
 ...
 officialClosure: '✅ This project has been officially closed and archived.'
 };
 ...
 return `${months} ${t.organizationModule.months} (${days} ${t.organizationModule.days})`;
 };
