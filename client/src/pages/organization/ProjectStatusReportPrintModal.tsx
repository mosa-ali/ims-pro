...
export function ProjectStatusReportPrintModal({
 ...
 const labels = {
 title: t.organizationModule.projectStatusReport,
 subtitle: t.organizationModule.progressPerformanceUpdate,
 ...
 overallStatus: t.organizationModule.overallStatus,
 completion: t.organizationModule.completion,
 
 onTrack: t.organizationModule.onTrack22,
 atRisk: t.organizationModule.atRisk,
 offTrack: t.organizationModule.offTrack,
 ...
 accomplishments: t.organizationModule.k2KeyAccomplishments,
 planned: t.organizationModule.k3PlannedActivitiesNextPeriod,
 
 milestones: t.organizationModule.k4MilestoneStatus,
 milestone: t.organizationModule.milestone,
 plannedDate: t.organizationModule.plannedDate,
 actualDate: t.organizationModule.actualDate,
 status: t.organizationModule.status,
 
 issues: t.organizationModule.k5IssuesConcerns,
 issue: t.organizationModule.issue,
 impact: t.organizationModule.impact,
 
 risks: t.organizationModule.k6RiskRegister,
 risk: t.organizationModule.risk,
 probability: t.organizationModule.probability,
 mitigation: t.organizationModule.mitigation,
 
 budget: t.organizationModule.k7BudgetStatus,
 budgeted: t.organizationModule.budgeted,
 spent: t.organizationModule.spent15,
 committed: t.organizationModule.committed,
 remaining: t.organizationModule.remaining,
 variance: t.organizationModule.variance,
 
 high: t.organizationModule.high23,
 medium: t.organizationModule.medium24,
 low: t.organizationModule.low25,
 open: t.organizationModule.open,
 inProgress: t.organizationModule.inProgress,
 resolved: t.organizationModule.resolved,
