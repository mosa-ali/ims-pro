...
export function PerformanceAppraisalCard({
 ...
 const localT = {
 title: t.hrEmployeeCards.performanceAppraisal,
 subtitle: t.hrEmployeeCards.performanceReviewsAndEvaluations,
 addReview: t.hrEmployeeCards.addReview,
 addAppraisalForm: t.hrEmployeeCards.addAppraisalForm,
 noReviews: t.hrEmployeeCards.noPerformanceReviewsYet,
 
 // Table headers
 reviewPeriod: t.hrEmployeeCards.reviewPeriod,
 type: t.hrEmployeeCards.type,
 reviewDate: t.hrEmployeeCards.reviewDate,
 reviewedBy: t.hrEmployeeCards.reviewedBy,
 overallRating: t.hrEmployeeCards.overallRating,
 status: t.hrEmployeeCards.status,
 actions: t.hrEmployeeCards.actions,
 
 // Status labels
 draft: t.hrEmployeeCards.draft,
 completed: t.hrEmployeeCards.completed,
 acknowledged: t.hrEmployeeCards.acknowledged,
 locked: t.hrEmployeeCards.locked,
 
 // Actions
 edit: t.hrEmployeeCards.edit,
 delete: t.hrEmployeeCards.delete,
 deleteConfirm: t.hrEmployeeCards.areYouSureYouWantTo,
 ...
 {t.hrEmployeeCards.officialAppraisalForms}
 </h4>
 ...
 <p>{t.hrEmployeeCards.reviewer}: {appraisal.reviewerName}</p>
 <p>{t.hrEmployeeCards.date}: {formatDate(appraisal.reviewDate)}</p>
 </div>
 </div>
 <button
 ...
 <span>{t.hrEmployeeCards.print}</span>
 </button>
 </div>
 </div>
 ))}
