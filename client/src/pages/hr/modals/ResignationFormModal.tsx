...
export function ResignationFormModal({
 ...
 const localT = {
 title: t.hrModals.resignationLetter,
 subtitle: t.hrModals.officialEmployeeResignation,
 ...
 resignationDate: t.hrModals.resignationDate,
 lastWorkingDay: t.hrModals.lastWorkingDay,
 reason: t.hrModals.reasonForResignation,
 noticePeriod: t.hrModals.noticePeriodDays,
 
 acknowledgedBy: t.hrModals.acknowledgedBy16,
 acknowledgedByRole: t.hrModals.rolePosition,
 ...
 success: t.hrModals.resignationSubmittedSuccessfullyExitProcessStarted,
 warning: 'Submitting resignation will start the exit process. This cannot be undone.'
 };
 ...
 placeholder={t.hrModals.hrSupervisorName}
 className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500"
 />
 </div>
 <div>
