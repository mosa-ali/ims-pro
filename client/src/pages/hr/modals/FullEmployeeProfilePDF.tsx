...
export function FullEmployeeProfilePDF({
 ...
 const { data: activeSalaryRecord, isLoading } = trpc.hrSalaryScale.getActiveByStaffId.useQuery(
 { staffId: employee.staffId },
 { enabled: !!employee.staffId }
 );
 ...
 <div>
 <h1 className="text-3xl font-bold text-gray-900">{localT.organizationName}</h1>
 <p className="text-sm text-gray-600 mt-1">{localT.title}</p>
 </div>
 <div className="text-end">
 <p className="text-xs text-gray-500">{localT.generatedOn}:</p>
 ...
 <p className="text-xs font-semibold text-red-800 text-center">{localT.confidential}</p>
 </div>
 </div>
 ...
 <div>
 <p className="text-xs text-gray-500 mb-1">{t.hrModals.staffId}</p>
 <p className="text-sm font-mono font-bold text-blue-600">{employee.staffId}</p>
 </div>
 <div>
 <p className="text-xs text-gray-500 mb-1">{t.hrModals.fullName}</p>
 <p className="text-sm font-semibold text-gray-900">{employee.fullName}</p>
 </div>
 <div>
 <p className="text-xs text-gray-500 mb-1">{t.hrModals.position}</p>
 <p className="text-sm text-gray-900">{employee.position || '-'}</p>
 </div>
 <div>
 <p className="text-xs text-gray-500 mb-1">{t.hrModals.status}</p>
 ...
 {localT.identitySection}
 </h2>
 <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
 <div className="space-y-3">
 <div>
 <p className="text-xs text-gray-500">{t.hrModals.gender}</p>
 <p className="text-sm text-gray-900">{employee.gender || '-'}</p>
 </div>
 <div>
 <p className="text-xs text-gray-500">{t.hrModals.nationality}</p>
 <p className="text-sm text-gray-900">{employee.nationality || '-'}</p>
 </div>
 <div>
 <p className="text-xs text-gray-500">{t.hrModals.dateOfBirth}</p>
 <p className="text-sm text-gray-900">{formatDate(employee.dateOfBirth)}</p>
 </div>
 <div>
 <p className="text-xs text-gray-500">{t.hrModals.supervisor}</p>
 <p className="text-sm text-gray-900">{employee.supervisor || '-'}</p>
 </div>
 </div>
 <div className="space-y-3">
 <div>
 <p className="text-xs text-gray-500">{t.hrModals.phone}</p>
 <p className="text-sm text-gray-900">{employee.phoneNumber || '-'}</p>
 </div>
 <div>
 <p className="text-xs text-gray-500">{t.hrModals.email}</p>
 <p className="text-sm text-gray-900">{employee.email || '-'}</p>
 </div>
 <div>
 <p className="text-xs text-gray-500">{t.hrModals.address}</p>
 ...
 <div className="mb-8 page-break-inside-avoid">
 <h2 className="text-xl font-bold text-gray-900 mb-4 pb-2 border-b border-gray-300">
 {localT.employmentSection}
 </h2>
 <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
 <div className="space-y-3">
 <div>
 <p className="text-xs text-gray-500">{t.hrModals.department}</p>
 <p className="text-sm text-gray-900">{employee.department || '-'}</p>
 </div>
 <div>
 <p className="text-xs text-gray-500">{t.hrModals.hireDate}</p>
 <p className="text-sm text-gray-900">{formatDate(employee.hireDate)}</p>
 </div>
 <div>
 <p className="text-xs text-gray-500">{t.hrModals.contractType}</p>
 <p className="text-sm text-gray-900">{employee.contractType || '-'}</p>
 </div>
 <div>
 <p className="text-xs text-gray-500">{t.hrModals.employmentType}</p>
 <p className="text-sm text-gray-900">{employee.employmentType || '-'}</p>
 </div>
 </div>
 <div className="space-y-3">
 <div>
 <p className="text-xs text-gray-500">{t.hrModals.project}</p>
 <p className="text-sm text-gray-900">{employee.projects || '-'}</p>
 </div>
 <div>
 <p className="text-xs text-gray-500">{t.hrModals.contractStart}</p>
 <p className="text-sm text-gray-900">{formatDate(employee.contractStartDate)}</p>
 </div>
 <div>
 <p className="text-xs text-gray-500">{t.hrModals.contractEnd}</p>
 ...
 <p className="text-sm font-bold text-green-800">{localT.grossSalary}</p>
 ...
 <p className="text-sm text-yellow-800 italic">{localT.noActiveSalary}</p>
 </div>
 )}
 </div>
