...
export function EditIdentityProfileModal({
 ...
 const localT = {
 title: t.hrModals.editIdentityPersonalProfile,
 subtitle: t.hrModals.updateCoreEmployeeInformation,
 
 // Read-only fields labels
 readOnlySection: t.hrModals.readonlyInformation,
 staffId: t.hrModals.staffId,
 hireDate: t.hrModals.hireDate,
 status: t.hrModals.status,
 
 // Editable fields
 editableSection: t.hrModals.editableInformation,
 ...
 phone: t.hrModals.phoneNumber,
 email: t.hrModals.emailAddress,
 address: t.hrModals.fullAddress,
 supervisor: t.hrModals.supervisor,
 
 // Uploads
 uploadsSection: t.hrModals.documentUploads,
 identification: t.hrModals.identificationCopy,
 cv: t.hrModals.cvResume,
 ...
 invalidEmail: t.hrModals.invalidEmailFormat
 };
 ...
 className={`w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent ${ errors.nationality ? 'border-red-500' : 'border-gray-300' }`}
 />
 ...
 className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
 placeholder={t.hrModals.nameOfDirectSupervisor}
 />
 </div>
 </div>
 </div>
