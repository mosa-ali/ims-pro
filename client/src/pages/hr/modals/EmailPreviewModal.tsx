...
export function EmailPreviewModal({
 ...
 return new Date(dateString).toLocaleString(t.hrModals.en, {
 year: 'numeric',
 month: 'long',
 day: 'numeric',
 hour: '2-digit',
 ...
 const localT = {
 title: t.hrModals.emailPreview,
 simulatedLabel: 'Simulated Notification (Frontend-Only)',
 simulatedDesc: 'This is a demonstration. No actual email was sent. Real email sending requires backend integration.',
 from: t.hrModals.from,
 to: t.hrModals.to7,
 subject: t.hrModals.subject8,
 sentAt: t.hrModals.sentAt,
 status: t.hrModals.status,
 simulated: t.hrModals.simulated,
 messageBody: t.hrModals.messageBody,
