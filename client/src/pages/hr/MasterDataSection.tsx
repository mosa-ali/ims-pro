...
export function MasterDataSection({
 ...
 subtitle: t.hr.masterDataSubtitle,
 ...
 <tr>
 <th className={`px-6 py-3 text-xs font-medium text-gray-500 uppercase text-start`}>{labels.name}</th>
 <th className={`px-6 py-3 text-xs font-medium text-gray-500 uppercase text-start`}>{labels.active}</th>
 <th className={`px-6 py-3 text-xs font-medium text-gray-500 uppercase text-start`}>{labels.createdDate}</th>
 <th className={`px-6 py-3 text-xs font-medium text-gray-500 uppercase text-start`}>{labels.actions}</th>
 </tr>
 </thead>
