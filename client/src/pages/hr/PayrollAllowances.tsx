 ...
 * ✅ Full CRUD operations with tRPC persistence
...
export function PayrollAllowances() {
 ...
 // NOTE: organizationId and operatingUnitId are injected from ctx.scope (server-side)
 ...
 const updateStatusMutation = trpc.hrPayroll.update.useMutation({
 onSuccess: () => {
