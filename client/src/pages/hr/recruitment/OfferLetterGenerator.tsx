...
5. You will be required to sign a confidentiality agreement.`,
 ...
 const localT = {
 title: t.hrRecruitment.generateOfferLetter,
 editForm: t.hrRecruitment.editOfferDetails,
 preview: t.hrRecruitment.preview,
 
 // Form sections
 organizationDetails: t.hrRecruitment.organizationDetails,
 candidateDetails: t.hrRecruitment.candidateDetails,
 positionDetails: t.hrRecruitment.positionDetails,
 employmentTerms: t.hrRecruitment.employmentTerms,
 compensation: t.hrRecruitment.compensationBenefits,
 termsConditions: t.hrRecruitment.termsConditions,
 
 // Fields
 organizationName: t.hrRecruitment.organizationName,
 organizationAddress: t.hrRecruitment.address,
 organizationPhone: t.hrRecruitment.phone,
 organizationEmail: t.hrRecruitment.email,
 organizationWebsite: t.hrRecruitment.website,
 letterDate: t.hrRecruitment.letterDate,
 referenceNumber: t.hrRecruitment.referenceNumber,
 letterHeading: t.hrRecruitment.letterHeading,
 
 candidateName: t.hrRecruitment.candidateName,
 candidateAddress: t.hrRecruitment.candidateAddress,
 
 positionTitle: t.hrRecruitment.positionTitle,
 department: t.hrRecruitment.department,
 reportingTo: t.hrRecruitment.reportingTo,
 workLocation: t.hrRecruitment.workLocation,
 
 employmentType: t.hrRecruitment.employmentType,
 startDate: t.hrRecruitment.startDate,
 contractEndDate: t.hrRecruitment.contractEndDateIfApplicable,
 probationPeriod: t.hrRecruitment.probationPeriod,
 
 salary: t.hrRecruitment.salary,
 currency: t.hrRecruitment.currency,
 salaryFrequency: t.hrRecruitment.frequency,
 annualLeave: t.hrRecruitment.annualLeave,
 medicalInsurance: t.hrRecruitment.medicalInsurance,
 otherBenefits: t.hrRecruitment.otherBenefits,
 workingHours: t.hrRecruitment.workingHours,
 
 termsText: t.hrRecruitment.termsConditions,
 additionalNotes: t.hrRecruitment.additionalNotes,
 
 signatoryName: t.hrRecruitment.signatoryName,
 signatoryTitle: t.hrRecruitment.signatoryTitle,
 
 // Actions
 save: t.hrRecruitment.saveOfferLetter,
 print: t.hrRecruitment.printSavePdf,
 cancel: t.hrRecruitment.cancel,
 
 // Letter content
 dear: t.hrRecruitment.dear,
 offerSubject: t.hrRecruitment.subjectOfferOfEmployment,
 openingPara: 'We are pleased to offer you the position of',
 closingPara: 'We look forward to welcoming you to our team. Please sign and return a copy of this letter to confirm your acceptance.',
 sincerely: t.hrRecruitment.sincerely,
 candidateAcceptance: t.hrRecruitment.candidateAcceptance,
 signature: t.hrRecruitment.signature,
 ...
 <div className="text-sm whitespace-pre-line text-gray-700 ps-4">
 ...
 <p className="text-sm text-gray-700 whitespace-pre-line ps-4">
 {formData.additionalNotes}
 </p>
 </div>
 )}
