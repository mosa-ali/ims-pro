...
export function HiringDecisionComponent({
 ...
 interviewedCandidates: t.hrRecruitment.interviewedCandidates,
 
 candidateRef: t.hrRecruitment.ref,
 name: t.hrRecruitment.name,
 email: t.hrRecruitment.email1,
 appScore: t.hrRecruitment.appScore,
 intScore: t.hrRecruitment.interviewScore,
 status: t.hrRecruitment.status,
 actions: t.hrRecruitment.actions,
 
 makeDecision: t.hrRecruitment.makeDecision,
 hiringDecision: t.hrRecruitment.hiringDecision,
 proposedTerms: t.hrRecruitment.proposedTerms,
 
 grade: t.hrRecruitment.grade,
 step: t.hrRecruitment.step,
 salary: t.hrRecruitment.proposedSalary,
 contractType: t.hrRecruitment.contractType,
 startDate: t.hrRecruitment.startDate,
 
 fixedTerm: t.hrRecruitment.fixedterm,
 shortTerm: t.hrRecruitment.shortterm,
 consultancy: t.hrRecruitment.consultancy,
 volunteer: t.hrRecruitment.volunteer,
 
 approve: t.hrRecruitment.approveHire,
 reject: t.hrRecruitment.reject,
 cancel: t.hrRecruitment.cancel,
 
 autoCreate: t.hrRecruitment.uponApprovalSystemWillAutomaticallyCreate,
 staffRecord: t.hrRecruitment.staffDictionaryRecord,
 employeeProfile: t.hrRecruitment.employeeProfile,
 
 noCandidates: t.hrRecruitment.noInterviewedCandidates
 };
 ...
 className={`w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 ${ errors.proposedSalary ? 'border-red-500' : 'border-gray-300' }`}
