...
export function InterviewEvaluationForm({
 language, isRTL, interview, onClose, onSave }: Props) {
 ...
 >
 <Star
 className={`w-8 h-8 ${ star <= value ? 'fill-yellow-400 text-yellow-400' : 'fill-none text-gray-300' }`}
 />
 </button>
 ))}
 <span className="ms-2 text-sm text-gray-600">{value}/5</span>
 </div>
 </div>
 );
 ...
 ratings: t.hrRecruitment.evaluationRatings,
 recommendation: t.hrRecruitment.recommendation,
 
 technicalSkills: t.hrRecruitment.technicalSkills,
 communicationSkills: t.hrRecruitment.communicationSkills,
 problemSolving: t.hrRecruitment.problemSolving,
 culturalFit: t.hrRecruitment.culturalFit,
 motivation: t.hrRecruitment.motivationEnthusiasm,
 overallRating: t.hrRecruitment.overallRating,
 
 recommendationLabel: t.hrRecruitment.finalRecommendation,
 highlyRecommended: t.hrRecruitment.highlyRecommended,
 recommended: t.hrRecruitment.recommended,
 notRecommended: t.hrRecruitment.notRecommended,
 onHold: t.hrRecruitment.onHold,
 
 strengths: t.hrRecruitment.keyStrengths,
 weaknesses: t.hrRecruitment.areasForImprovement,
 evaluationNotes: t.hrRecruitment.additionalNotes,
 
 interviewStatus: t.hrRecruitment.interviewStatus,
 ...
 save: t.hrRecruitment.saveEvaluation,
 ...
 <span className="ms-2 font-mono text-gray-900">{candidate?.candidateRef}</span>
 </div>
 <div>
 <span className="text-gray-500">Score:</span>
 <span className="ms-2 font-medium text-green-600">{candidate?.totalScore.toFixed(1)}%</span>
 </div>
 <div>
 <span className="text-gray-500">Interview Date:</span>
 <span className="ms-2 text-gray-900">{new Date(interview.scheduledDate).toLocaleDateString()}</span>
 </div>
 </div>
 </div>
 ...
 >
 <Star
 className={`w-10 h-10 ${ star <= formData.overallRating ? 'fill-yellow-400 text-yellow-400' : 'fill-none text-gray-300' }`}
 />
 </button>
 ))}
 <span className="ms-2 text-lg font-bold text-gray-900">{formData.overallRating}/5</span>
 </div>
 ...
 rows={3}
 className={`w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 ${ errors.strengths ? 'border-red-500' : 'border-gray-300' }`}
 placeholder={t.placeholders.listTheCandidateSKeyStrengths}
 />
 ...
 rows={3}
 className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
 placeholder={t.placeholders.listAreasForImprovement}
 />
 </div>
 ...
 rows={4}
 className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
 placeholder={t.placeholders.anyAdditionalObservationsOrComments}
 />
 </div>
 </form>
