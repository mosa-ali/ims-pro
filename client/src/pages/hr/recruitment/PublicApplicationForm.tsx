...
export function PublicApplicationForm() {
 ...
 placeholder={t.placeholders.enterYourFullName}
 />
 ...
 placeholder={t.placeholders.eGJordanian}
 />
 ...
 className={`w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 ${ errors.dateOfBirth ? 'border-red-500' : 'border-gray-300' }`}
 />
 ...
 placeholder={t.placeholders.yourEmailExampleCom}
 />
 ...
 className={`w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 ${ errors.currentLocation ? 'border-red-500' : 'border-gray-300' }`}
 ...
 className={`w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 ${ errors.educationLevel ? 'border-red-500' : 'border-gray-300' }`}
 >
 ...
 className={`w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 ${ errors.fieldOfStudy ? 'border-red-500' : 'border-gray-300' }`}
 placeholder={t.placeholders.eGComputerScience}
 />
 ...
 className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
 placeholder={t.placeholders.companyOrganization}
 />
 </div>
 ...
 className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
 placeholder={t.placeholders.yourCurrentRole}
 />
 </div>
 </div>
 </div>
 ...
 className={`mt-1 w-4 h-4 text-blue-600 rounded focus:ring-2 focus:ring-blue-500 ${ errors.declaration ? 'border-red-500' : '' }`}
 />
 ...
 {errors.declaration && <p className="text-xs text-red-500 mt-2 ms-7">{errors.declaration}</p>}
 </div>
