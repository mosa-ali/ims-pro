...
export function VacancyList({
 ...
 if (confirm('Are you sure you want to archive this vacancy?')) {
 ...
 const localT = {
 title: t.hrRecruitment.vacancies,
 search: t.hrRecruitment.searchVacancies,
 all: t.hrRecruitment.all,
 draft: t.hrRecruitment.draft,
 open: t.hrRecruitment.open,
 closed: t.hrRecruitment.closed,
 archived: t.hrRecruitment.archived,
 ...
 openingDate: t.hrRecruitment.opening,
 closingDate: t.hrRecruitment.closing,
 candidates: t.hrRecruitment.candidates,
 status: t.hrRecruitment.status,
 actions: t.hrRecruitment.actions,
 
 // Actions
 newVacancy: t.hrRecruitment.newVacancy,
 edit: t.hrRecruitment.edit,
 view: t.hrRecruitment.view,
 closeVacancy: t.hrRecruitment.close,
 archive: t.hrRecruitment.archive,
 copyLink: t.hrRecruitment.copyApplicationLink,
 linkCopied: t.hrRecruitment.linkCopied,
 viewApplications: t.hrRecruitment.viewApplications,
 
 // Empty state
 noVacancies: t.hrRecruitment.noVacanciesFound,
 createFirst: t.hrRecruitment.createYourFirstVacancyToStart
 };
 ...
 className={`px-3 py-2 rounded-lg text-sm font-medium transition-colors ${ statusFilter === status ? 'bg-blue-600 text-white' : 'bg-gray-100 text-gray-700 hover:bg-gray-200' }`}
 >
