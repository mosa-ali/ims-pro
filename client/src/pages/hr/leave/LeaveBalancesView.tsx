...
export function LeaveBalancesView({
 ...
 const localT = {
 title: t.hrLeave.staffLeaveBalances,
 subtitle: t.hrLeave.annualLeaveEntitlementsAndBalancesFor,
 ...
 opening: t.hrLeave.opening,
 used: t.hrLeave.used,
 pending: t.hrLeave.pending3,
 remaining: t.hrLeave.remaining,
 available: t.hrLeave.available,
 actions: t.hrLeave.actions,
 requestLeave: t.hrLeave.requestLeave,
 
 days: t.hrLeave.days4,
 noStaff: t.hrLeave.noActiveStaffFound,
 
 totalStaff: t.hrLeave.totalActiveStaff,
 avgBalance: t.hrLeave.avgAvailableBalance,
 totalUsed: t.hrLeave.totalLeaveUsed,
 totalPending: t.hrLeave.totalPending
 };
