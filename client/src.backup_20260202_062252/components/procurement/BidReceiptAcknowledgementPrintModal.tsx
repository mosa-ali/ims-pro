      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-5xl flex flex-col max-h-[90vh] overflow-hidden">
        ...
        <div className="px-6 py-4 border-b border-gray-100 flex items-center justify-between bg-white sticky top-0 z-10">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-lg font-bold text-gray-900">Print Bid Receipt</h2>
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex bg-gray-100 p-1 rounded-lg">
              ...
              <button 
                ...
                className={`px-3 py-1 rounded-md text-[10px] font-bold transition-all ${
                  language === 'ar' ? 'bg-white text-blue-600 shadow-sm' : 'text-gray-500 hover:text-gray-700'
                }`}
              >
                العربية
              </button>
        ...
        <div className="px-6 py-4 border-t border-gray-100 flex justify-end gap-3 bg-white sticky bottom-0 z-10">
          <p className="mr-auto text-[10px] text-gray-400 font-medium flex items-center gap-1">
            <Languages className="w-3 h-3" />
            Selected Language: {language === 'en' ? 'English (LTR)' : 'Arabic (RTL)'}
          </p>
          <button 
            onClick={onClose}
