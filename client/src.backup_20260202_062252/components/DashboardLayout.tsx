...
function DashboardLayoutContent({
  ...
  // Detect RTL direction and listen for language changes
  ...
  // Force sidebar positioning after render to fix RTL layout
  useEffect(() => {
    ...
    const timer = setTimeout(() => {
      ...
      if (container) {
        ...
        if (isRTL) {
          (container as HTMLElement).style.setProperty('left', 'auto', 'important');
          (container as HTMLElement).style.setProperty('right', '0', 'important');
        } else {
          (container as HTMLElement).style.setProperty('left', '0', 'important');
          (container as HTMLElement).style.setProperty('right', 'auto', 'important');
        }
      }
    }, 0);
        ...
        >
          <SidebarHeader className="h-16 justify-center">
            <div className="flex items-center gap-3 px-2 transition-all w-full">
              ...
              {!isCollapsed ? (
                <div className={`flex items-center gap-2 min-w-0 flex-1 ${isRTL ? 'flex-row' : 'flex-row-reverse'}`}>
                  <LanguageSwitcher />
