/**
 * Finance Chart of Accounts Page
 * 
 * Standalone page for Chart of Accounts management.
...
export default function FinanceChartOfAccounts() {
  ...
  const pageT = {
    title: language === 'en' ? 'Chart of Accounts' : 'دليل الحسابات',
    subtitle: language === 'en' 
      ? 'Manage account codes, categories, and financial structure' 
      : 'إدارة رموز الحسابات والفئات والهيكل المالي',
