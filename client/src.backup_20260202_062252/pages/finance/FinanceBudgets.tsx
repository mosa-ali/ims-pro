 ...
 * 
 * Standalone page for Budgets management.
...
export default function FinanceBudgets() {
  ...
  const pageT = {
    title: language === 'en' ? 'Budgets' : 'الميزانيات',
    subtitle: language === 'en' 
      ? 'Create, submit, approve, and track project and organizational budgets' 
      : 'إنشاء وتقديم واعتماد وتتبع ميزانيات المشاريع والمنظمة',
