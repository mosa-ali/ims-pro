...
export function ProjectStatusReportPrintModal({
  ...
  const t = {
    title: language === 'en' ? 'PROJECT STATUS REPORT' : 'تقرير حالة المشروع',
    subtitle: language === 'en' ? 'Progress & Performance Update' : 'تحديث التقدم والأداء',
    ...
    overallStatus: language === 'en' ? 'Overall Status' : 'الحالة العامة',
    completion: language === 'en' ? 'Completion' : 'نسبة الإنجاز',
    
    onTrack: language === 'en' ? 'On Track' : 'على المسار الصحيح',
    ...
    accomplishments: language === 'en' ? '2. Key Accomplishments' : '2. الإنجازات الرئيسية',
    planned: language === 'en' ? '3. Planned Activities (Next Period)' : '3. الأنشطة المخططة (الفترة القادمة)',
    
    milestones: language === 'en' ? '4. Milestone Status' : '4. حالة المعالم',
    milestone: language === 'en' ? 'Milestone' : 'المعلم',
    plannedDate: language === 'en' ? 'Planned Date' : 'التاريخ المخطط',
    actualDate: language === 'en' ? 'Actual Date' : 'التاريخ الفعلي',
    status: language === 'en' ? 'Status' : 'الحالة',
    
    issues: language === 'en' ? '5. Issues & Concerns' : '5. المشاكل والمخاوف',
    issue: language === 'en' ? 'Issue' : 'المشكلة',
    impact: language === 'en' ? 'Impact' : 'التأثير',
    
    risks: language === 'en' ? '6. Risk Register' : '6. سجل المخاطر',
    risk: language === 'en' ? 'Risk' : 'المخاطر',
    probability: language === 'en' ? 'Probability' : 'الاحتمالية',
    mitigation: language === 'en' ? 'Mitigation' : 'التخفيف',
    
    budget: language === 'en' ? '7. Budget Status' : '7. حالة الميزانية',
    budgeted: language === 'en' ? 'Budgeted' : 'المخطط',
    spent: language === 'en' ? 'Spent' : 'المنفق',
    committed: language === 'en' ? 'Committed' : 'الملتزم',
    ...
    resolved: language === 'en' ? 'Resolved' : 'محلول',
        ...
        <div className="p-8" dir={isRTL ? 'rtl' : 'ltr'}>
          ...
          <div className="flex items-start justify-between mb-8 pb-6 border-b-2 border-gray-300">
            ...
            <div className={`text-sm ${isRTL ? 'text-left' : 'text-right'}`}>
              <p className="text-gray-600">{t.docNumber}: PSR-{projectCode}-{new Date().getFullYear()}</p>
          ...
          <div className="grid grid-cols-2 gap-4 mb-6">
            ...
            <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
              <h3 className="text-base font-semibold text-gray-900 mb-3">{t.projectInfo}</h3>
              <div className="space-y-2">
                <div>
                  <p className="text-xs text-gray-600">{t.projectCode}</p>
                  <p className="text-sm font-semibold text-gray-900">{projectCode}</p>
                </div>
                <div>
                  <p className="text-xs text-gray-600">{t.projectManager}</p>
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
              <h3 className="text-base font-semibold text-gray-900 mb-3">{t.overallStatus}</h3>
              <div className="space-y-3">
                ...
                <div>
                  <p className="text-xs text-gray-600 mb-1">{t.completion}</p>
          ...
          {/* 2. Accomplishments */}
          <div className="mb-6">
            <h3 className="text-lg font-semibold text-gray-900 mb-3">{t.accomplishments}</h3>
          ...
          <div className="mb-6">
            <h3 className="text-lg font-semibold text-gray-900 mb-3">{t.planned}</h3>
          ...
          {/* 4. Milestones */}
          <div className="mb-6">
            <h3 className="text-lg font-semibold text-gray-900 mb-3">{t.milestones}</h3>
          ...
          <div className="mb-6">
            ...
            <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
              <div className="grid grid-cols-5 gap-4">
                ...
                <div className="text-center">
                  <p className="text-xs text-gray-600 mb-1">{t.variance}</p>
              ...
              <div className="mt-4">
                <div className="flex items-center gap-2 mb-1">
                  <span className="text-xs text-gray-600">{t.spent}</span>
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-8">
                <div>
                  ...
                  <p className="text-xs text-gray-500">{t.projectManager}</p>
                </div>
                <div>
