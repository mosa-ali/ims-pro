...
export default function ProjectsCRUDPage() {
  ...
  const createMutation = trpc.projects.create.useMutation({
    onSuccess: () => {
      ...
      utils.projects.getDashboardKPIs.invalidate();
      ...
      <div className="container mx-auto px-6 py-8">
        ...
        <div className="bg-white rounded-lg border border-gray-200 overflow-hidden">
          <div className="p-6 border-b border-gray-200 flex items-center justify-between">
            <h3 className="text-lg font-semibold text-gray-900">{t.projectList}</h3>
              ...
              projects.map((project: any) => (
                <div key={project.id} className="border border-gray-200 rounded-lg p-6 hover:shadow-md transition-shadow">
                    ...
                    <div className="flex-1">
                      <div className="flex items-center gap-3 mb-2">
                        ...
                        <span className={`px-2 py-1 text-xs font-semibold rounded ${
                          ...
                          {t[project.status === 'not_started' ? 'notStarted' : project.status]}
                        </span>
                      </div>
                      <div className="text-sm text-gray-600 mb-1">
                        {t.projectCode}: <span className="font-mono font-semibold">{project.code}</span>
                      </div>
                      {project.donor && (
                        <div className="text-sm text-gray-600">
                          {t.donor}: <span className="font-semibold">{project.donor}</span>
                        </div>
                      )}
                    </div>
                    <div className="text-right">
                      <div className="text-sm text-gray-600 mb-1">{t.budgetUtilization}</div>
                      ...
                      <div className="w-32 h-2 bg-gray-200 rounded-full overflow-hidden">
                        <div 
                          className={`h-full ${
                            ...
                            project.budgetUtilization >= 75 ? 'bg-yellow-500' :
                            'bg-green-500'
                          }`}
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-5 gap-4 mb-4">
                    <div>
                      <div className="text-xs text-gray-600 mb-1">{t.startDate}</div>
                    ...
                    <div>
                      <div className="text-xs text-gray-600 mb-1">{t.endDate}</div>
                      <div className="text-sm font-semibold text-gray-900">
                    ...
                    <div>
                      <div className="text-xs text-gray-600 mb-1">{t.daysRemaining}</div>
                      <div className="text-sm font-semibold text-gray-900">
                        {(() => {
                    ...
                    <div>
                      <div className="text-xs text-gray-600 mb-1">{t.totalBudgetLabel}</div>
                      <div className="text-sm font-semibold text-gray-900">{Number(project.totalBudget).toLocaleString()}</div>
                    </div>
                    <div>
                      <div className="text-xs text-gray-600 mb-1">{t.currency}</div>
