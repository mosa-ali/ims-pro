...
export function InterviewScheduling({ language, isRTL }: Props) {
  ...
  const t = {
    title: language === 'en' ? 'Interview Scheduling' : 'جدولة المقابلات',
    selectVacancy: language === 'en' ? 'Select Vacancy' : 'اختر الشاغر',
    shortlistedCandidates: language === 'en' ? 'Shortlisted Candidates' : 'المرشحون في القائمة المختصرة',
    ...
    schedule: language === 'en' ? 'Schedule Interview' : 'جدولة مقابلة',
    
    scheduleInterview: language === 'en' ? 'Schedule Interview' : 'جدولة مقابلة',
    interviewDate: language === 'en' ? 'Interview Date' : 'تاريخ المقابلة',
    interviewTime: language === 'en' ? 'Interview Time' : 'وقت المقابلة',
    interviewType: language === 'en' ? 'Interview Type' : 'نوع المقابلة',
    panelMembers: language === 'en' ? 'Panel Members' : 'أعضاء اللجنة',
    addMember: language === 'en' ? 'Add Member' : 'إضافة عضو',
    notes: language === 'en' ? 'Notes' : 'ملاحظات',
    
    phoneScreening: language === 'en' ? 'Phone Screening' : 'مقابلة هاتفية',
    technicalInterview: language === 'en' ? 'Technical Interview' : 'مقابلة فنية',
    panelInterview: language === 'en' ? 'Panel Interview' : 'مقابلة لجنة',
    finalInterview: language === 'en' ? 'Final Interview' : 'مقابلة نهائية',
    
    cancel: language === 'en' ? 'Cancel' : 'إلغاء',
    scheduleBtn: language === 'en' ? 'Schedule' : 'جدولة',
    
    noCandidates: language === 'en' ? 'No shortlisted candidates found' : 'لا يوجد مرشحون في القائمة المختصرة'
  };
