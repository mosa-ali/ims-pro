...
export function CandidateList({ language, isRTL }: Props) {
  ...
  const t = {
    title: language === 'en' ? 'Candidate Management' : 'إدارة المرشحين',
    selectVacancy: language === 'en' ? 'Select Vacancy' : 'اختر الشاغر',
    all: language === 'en' ? 'All Candidates' : 'جميع المرشحين',
    longlist: language === 'en' ? 'Longlist' : 'القائمة الطويلة',
    shortlist: language === 'en' ? 'Shortlist' : 'القائمة المختصرة',
    
    exportLonglist: language === 'en' ? 'Export Longlist' : 'تصدير القائمة الطويلة',
    exportShortlist: language === 'en' ? 'Export Shortlist' : 'تصدير القائمة المختصرة',
    exportAll: language === 'en' ? 'Export All' : 'تصدير الكل',
    
    candidateRef: language === 'en' ? 'Ref' : 'المرجع',
    name: language === 'en' ? 'Name' : 'الاسم',
    email: language === 'en' ? 'Email' : 'البريد',
    phone: language === 'en' ? 'الهاتف' : 'Phone',
    ...
    approve: language === 'en' ? 'Approve' : 'قبول',
    reject: language === 'en' ? 'Reject' : 'رفض',
    
    noCandidates: language === 'en' ? 'No candidates found' : 'لا يوجد مرشحون',
    selectVacancyFirst: language === 'en' ? 'Please select a vacancy to view candidates' : 'يرجى اختيار شاغر لعرض المرشحين',
    
    totalCandidates: language === 'en' ? 'Total' : 'الإجمالي',
    shortlistedCount: language === 'en' ? 'Shortlisted' : 'القائمة المختصرة',
    threshold: language === 'en' ? 'Threshold' : 'الحد الأدنى'
  };
