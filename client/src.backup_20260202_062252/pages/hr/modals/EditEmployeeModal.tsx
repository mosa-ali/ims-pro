...
export function EditEmployeeModal({ employee, show, onClose, onEmployeeUpdated }: EditEmployeeModalProps) {
  ...
  const t = {
    title: language === 'en' ? 'Edit Employee Information' : 'تعديل معلومات الموظف',
